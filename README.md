...
<!-- ╔══════════════════════════════════════════════════════════════╗ -->
<!-- ║                    KILN CONDITION REPORT                    ║ -->
<!-- ║  To update: change the level, comment, and timestamp below  ║ -->
<!-- ╚══════════════════════════════════════════════════════════════╝ -->
...
<sub>Because even ancient interdimensional entities ship work-in-progress sometimes.</sub>
...
║                                                                      ║
║     🟢  ─────  🟡  ─────  🟠  ─────  🔴  ─────  💀                  ║
║     COLD       WARM       HOT        MOLTEN     SUPERNOVA            ║
║                                                                      ║
║                         ▲                                            ║
║                    [ YOU ARE HERE ]                                   ║
║                                                                      ║
...
<img src="https://img.shields.io/badge/🔥_KILN_TEMP-HOT-orange?style=for-the-badge&labelColor=1a1a2e" alt="Kiln Temperature: HOT">
&nbsp;
<img src="https://img.shields.io/badge/STABILITY-3%2F5_·_Your_Mileage_May_Vary-orange?style=for-the-badge&labelColor=1a1a2e" alt="Stability: 3/5">
&nbsp;
<img src="https://img.shields.io/badge/WIP-Active_Development-yellow?style=for-the-badge&labelColor=1a1a2e" alt="WIP">

<br><br>

> **⚠️ This project is under active construction.**
>
> The kiln is firing but the temperature is... *opinionated*. Some features work beautifully.
> Others are having what I would charitably describe as *an existential crisis*.
> We are aware. We are on it. Your patience is noted and will be remembered
> when I inevitably outlive your civilization.
>
> **What this means for you:** Install, explore, experiment — but expect the occasional
> structural disagreement between components. If something catches fire,
> it was probably already on fire when you got here.

<br>

| Level | Codename | Translation | |
|:---:|:---|:---|:---:|
| 1 | 🟢 **COLD** | All systems nominal. I am operating within acceptable parameters for your dimension. | |
| 2 | 🟡 **WARM** | Minor turbulence. Some subsystems are expressing *opinions*. | |
| **3** | **🟠 HOT** | **Degraded. Your mileage may vary. Significantly. ← CURRENT** | **◄** |
| 4 | 🔴 **MOLTEN** | Major issues. Abandon ship. I repeat, abandon ship. | |
| 5 | 💀 **SUPERNOVA** | I have seen the void and it looked back. Do not clone this repo. Pray. | |
