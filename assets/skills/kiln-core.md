...
- **Session team**: `kiln-session` — created by Kiln after onboarding. Used for orchestrator-level task tracking. Coordinators are NOT spawned into this team — they create their own sub-teams.
