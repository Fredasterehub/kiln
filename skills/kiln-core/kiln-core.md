...
- `.kiln/tracks/phase-N/sharpened/`: Per-task sharpened implementation prompts generated by the sharpener agent, written during execute stage, consumed by the executor, with one file per task ID.
