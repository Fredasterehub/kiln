...
HOOK_SCRIPT["teammate-idle-keeps-active"]="$HOOKS_DIR/activity-update.sh"
HOOK_SCRIPT["teammate-idle-feedback"]="$HOOKS_DIR/teammate-idle-feedback.sh"
HOOK_SCRIPT["ensure-watchdog"]="$HOOKS_DIR/ensure-watchdog.sh"
HOOK_SCRIPT["async-rewake-watchdog"]="$HOOKS_DIR/async-rewake-watchdog.sh"
HOOK_SCRIPT["deadlock-check"]="$HOOKS_DIR/deadlock-check.sh"
