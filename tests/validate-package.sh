...
if [ "$FAIL" -eq 0 ]; then
  required_paths=(
    ...
    "skills/kiln-tracker-plan/kiln-tracker-plan.md"
    "skills/kiln-tracker-validate/kiln-tracker-validate.md"
    "skills/kiln-tracker-execute/kiln-tracker-execute.md"
    "skills/kiln-tracker-e2e/kiln-tracker-e2e.md"
    "skills/kiln-tracker-review/kiln-tracker-review.md"
    "skills/kiln-tracker-reconcile/kiln-tracker-reconcile.md"
